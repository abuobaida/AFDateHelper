...
public extension Date {
    ...
    */
    func toString(_ format: DateFormat, timeZone: TimeZone = .local, locale: Locale = .english) -> String
    {
        var dateFormat: String
        let zone: Foundation.TimeZone
        let appliedLocale: Foundation.Locale
        switch format {
        case .dotNet:
        ...
        switch locale {
        case .currentLocale:
            appliedLocale = Foundation.Locale.current
        case .english:
            appliedLocale = Foundation.Locale(identifier: "en_US")
        case .arabic:
            appliedLocale = Foundation.Locale(identifier: "ar_SA")
        }
        
        let formatter = Date.formatter(dateFormat, timeZone: zone, locale: appliedLocale)
    ...
    */
    func toString(_ dateStyle: DateFormatter.Style, timeStyle: DateFormatter.Style, doesRelativeDateFormatting: Bool = false, timeZone: Foundation.TimeZone = Foundation.NSTimeZone.local, locale: Foundation.Locale = Foundation.Locale.current) -> String
    {
    ...
    */
    private static func formatter(_ format:String = DefaultFormat, timeZone: Foundation.TimeZone = Foundation.TimeZone.current, locale: Foundation.Locale = Foundation.Locale.current) -> DateFormatter {
    ...
    - Returns The date formatter.
    */
    private static func formatter(_ dateStyle: DateFormatter.Style, timeStyle: DateFormatter.Style, doesRelativeDateFormatting: Bool, timeZone: Foundation.TimeZone = Foundation.NSTimeZone.local, locale: Foundation.Locale = Foundation.Locale.current) -> DateFormatter {
        var formatters = Date.sharedDateFormatters()
